...
export const ThreadContainer = ({ children, className, }) => {
    return _jsx("div", { className: clsx("crayon-copilot-shell-thread-container", className), children: children });
};
export const ScrollArea = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector = ".crayon-copilot-shell-thread-message-user", }) => {
    ...
    return (_jsx("div", { ref: ref, className: clsx("crayon-copilot-shell-thread-scroll-area", {
            "crayon-copilot-shell-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor",
...
export const AssistantMessageContainer = ({ children, className, }) => {
    return (_jsx("div", { className: clsx("crayon-copilot-shell-thread-message-assistant", className), children: _jsx("div", { className: "crayon-copilot-shell-thread-message-assistant__content", children: children }) }));
};
export const UserMessageContainer = ({ children, className, }) => {
    return (_jsx("div", { className: clsx("crayon-copilot-shell-thread-message-user", className), children: _jsx("div", { className: "crayon-copilot-shell-thread-message-user__content", children: children }) }));
};
    ...
    if (message.role === "assistant") {
        return (_jsx(MessageContainer, { className: className, children: message.message?.map((stringOrTemplate, i) => {
                if (stringOrTemplate.type === "text") {
                    ...
                    return (_jsx(TextRenderer, { className: "crayon-copilot-shell-thread-message-assistant__text", children: stringOrTemplate.text }, i));
                }
...
export const MessageLoading = () => {
    return (_jsx("div", { className: "crayon-copilot-shell-thread-message-loading", children: _jsx(MessageLoadingComponent, {}) }));
};
export const Messages = ({ className, loader, }) => {
    const { messages, isRunning } = useThreadState();
    return (_jsxs("div", { className: clsx("crayon-copilot-shell-thread-messages", className), children: [messages.map((message) => {
...
export const Composer = ({ className }) => {
    ...
    return (_jsx("div", { className: clsx("crayon-copilot-shell-thread-composer", className), children: _jsxs("div", { className: "crayon-copilot-shell-thread-composer__input-wrapper", children: [_jsx("textarea", { ref: inputRef, value: textContent, onChange: (e) => setTextContent(e.target.value), className: "crayon-copilot-shell-thread-composer__input", placeholder: "Type your message...", onKeyDown: (e) => {
