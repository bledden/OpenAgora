...
export const Default = {
    ...
    render: (args) => (_jsx(Input, { size: args.size, placeholder: args.placeholder, disabled: args.disabled, value: args.value, onChange: args.onChange, hasError: args.hasError })),
};
...
const ControlledInput = () => {
    ...
    return (_jsx(Input, { size: "medium", value: value, onChange: (e) => setValue(e.target.value), placeholder: "Enter text..." }));
};
export const Controlled = {
    ...
    parameters: {
        docs: {
            description: {
                story: "This is a controlled input example. The input value is managed by the component's state.",
            },
            source: {
                code: `
import { useState } from "react";
...
const ValidatedInput = () => {
    ...
    return (_jsx(Input, { size: "medium", value: value, onChange: (e) => setValue(e.target.value), placeholder: "Enter 3-10 characters", hasError: hasError }));
};
export const LengthValidation = {
    render: () => _jsx(ValidatedInput, {}),
    parameters: {
        docs: {
            description: {
