...
export const ThemeProvider = ({ mode = "light", children, theme: userTheme = {}, darkTheme: userDarkTheme, cssSelector = "body", }) => {
    const id = useId();
    const baseTheme = themes[mode];
    const lightTheme = useShallow(() => ({ ...baseTheme, ...userTheme }))(undefined);
    const darkTheme = useShallow(() => ({ ...baseTheme, ...(userDarkTheme || userTheme) }))(undefined);
    const theme = mode === "light" ? lightTheme : darkTheme;
    const contextValue = useMemo(() => ({ theme, mode, portalThemeClassName: `crayon-theme-portal-${id}` }), [theme, mode, id]);
    return (_jsxs(ThemeContext.Provider, { value: contextValue, children: [_jsx("style", { children: `
