...
const BarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", tickVariant = "multiLine", grid = true, icons = {}, radius = BAR_RADIUS, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "crayon-bar-chart-y-axis-container", children: _jsxs(RechartsBarChart, { width: yAxisWidth, height: chartHeight, data: data, stackOffset: "sign", margin: {
                    top: 20,
    ...
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("crayon-bar-chart-container", className), style: {
                    width: width ? `${width}px` : undefined,
                }, children: [_jsxs("div", { className: "crayon-bar-chart-container-inner", ref: chartContainerRef, children: [yAxis, _jsx("div", { className: "crayon-bar-chart-main-container", ref: mainContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: { width: dataWidth, minWidth: "100%", height: chartHeight }, rechartsProps: {
                                        width: "100%",
                                        height: "100%",
                                        minHeight: 1,
                                        minWidth: 1,
