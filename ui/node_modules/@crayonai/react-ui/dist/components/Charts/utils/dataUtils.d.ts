...
export declare const getCategoricalChartConfig: <T extends CategoricalChartData>(data: T, categoryKey: keyof T[number], theme: string | undefined, transformedKeys: Record<string, string>) => ChartConfig;
/**
