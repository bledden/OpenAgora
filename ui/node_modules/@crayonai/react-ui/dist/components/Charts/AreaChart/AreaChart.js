...
const AreaChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "natural", tickVariant = "multiLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "crayon-area-chart-y-axis-container", children: _jsxs(RechartsAreaChart, { width: yAxisWidth, height: chartHeight, data: data, margin: {
                    top: 20,
    ...
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("crayon-area-chart-container", className), style: {
                    width: width ? `${width}px` : undefined,
                }, children: [_jsxs("div", { className: "crayon-area-chart-container-inner", ref: chartContainerRef, children: [yAxis, _jsx("div", { className: "crayon-area-chart-main-container", ref: mainContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: { width: dataWidth, minWidth: "100%", height: chartHeight }, rechartsProps: {
                                        width: "100%",
                                        height: "100%",
                                        minHeight: 1,
                                        minWidth: 1,
