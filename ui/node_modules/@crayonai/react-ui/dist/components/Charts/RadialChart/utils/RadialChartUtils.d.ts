 ...
 */
export declare const transformRadialDataWithPercentages: <T extends RadialChartData>(data: T, dataKey: keyof T[number], theme?: string) => {
    percentage: number;
...
export declare const transformRadialData: <T extends RadialChartData>(data: T, dataKey: keyof T[number], theme?: string) => {
    percentage: number;
    originalValue: string | number | undefined;
    fill: string | undefined;
}[];
