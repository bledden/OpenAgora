...
const meta = {
    ...
    argTypes: {
        data: {
            description: "An array of numbers or an array of objects with value and optional label. Each entry represents a single bar in the chart.",
            control: false,
            table: {
        ...
        theme: {
            description: "The color palette theme for the chart. Each theme provides a different set of colors for the bars.",
            control: "select",
...
export const SimpleNumberArray = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "280px", padding: "20px" }, children: [_jsx("h3", { style: { marginBottom: "16px", fontSize: "16px", fontWeight: "600" }, children: "Monthly Sales Data" }), _jsx(MiniBarChart, { ...args })] })),
    parameters: {
        docs: {
            source: {
                code: `
...
export const LabeledData = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "280px", padding: "20px" }, children: [_jsx("h3", { style: { marginBottom: "16px", fontSize: "16px", fontWeight: "600" }, children: "Monthly Revenue" }), _jsx(MiniBarChart, { ...args })] })),
    parameters: {
        docs: {
            source: {
                code: `
...
export const SmallSize = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "200px", padding: "16px" }, children: [_jsx("h4", { style: { marginBottom: "12px", fontSize: "14px", fontWeight: "600" }, children: "Weekly Stats" }), _jsx(MiniBarChart, { ...args })] })),
};
export const DifferentThemes = {
    ...
    render: () => (_jsx("div", { style: { display: "flex", gap: "20px", flexWrap: "wrap" }, children: ["ocean", "orchid", "emerald", "sunset", "spectrum", "vivid"].map((theme) => (_jsxs(Card, { style: { width: "200px", padding: "16px" }, children: [_jsxs("h4", { style: {
                    ...
                    }, children: [theme, " Theme"] }), _jsx(MiniBarChart, { data: [15, 25, 20, 35, 30, 18, 22], theme: theme, radius: 2, size: 160 })] }, theme))) })),
};
//# sourceMappingURL=MiniBarChart.stories.js.map