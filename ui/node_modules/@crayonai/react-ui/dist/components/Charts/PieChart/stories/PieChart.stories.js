...
`,
        ...
        categoryKey: {
            description: "**Required.** The key in your data object that represents the category label (e.g., 'month', 'department').",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
        ...
        dataKey: {
            description: "**Required.** The key in your data object that contains the numeric value for each slice (e.g., 'value', 'sales').",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
        ...
        customPalette: {
            description: "An array of color strings to use as a custom palette for the chart. This overrides the `theme` prop.",
            control: "object",
            table: {
                type: { summary: "string[]" },
                category: "🎨 Visual Styling",
...
export const InteractivePlayground = {
    ...
    render: (args) => _jsx(PieChart, { ...args }),
};
/**
...
export const DefaultConfiguration = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "400px", height: "fit-content", padding: "24px" }, children: [_jsx("h3", { style: { marginBottom: "20px", fontSize: "18px", fontWeight: 600 }, children: "Monthly Sales Performance" }), _jsx(PieChart, { ...args })] })),
};
/**
 ...
 */
export const LayoutAndVariantOptions = {
    ...
    render: (args) => (_jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", width: "800px" }, children: [_jsxs("div", { children: [_jsx("h4", { style: { textAlign: "center", marginBottom: "16px" }, children: "Pie - Circular" }), _jsx(Card, { style: { padding: "20px" }, children: _jsx(PieChart, { ...args, variant: "pie", appearance: "circular" }) })] }), _jsxs("div", { children: [_jsx("h4", { style: { textAlign: "center", marginBottom: "16px" }, children: "Donut - Circular" }), _jsx(Card, { style: { padding: "20px" }, children: _jsx(PieChart, { ...args, variant: "donut", appearance: "circular" }) })] }), _jsxs("div", { children: [_jsx("h4", { style: { textAlign: "center", marginBottom: "16px" }, children: "Pie - Semicircle" }), _jsx(Card, { style: { padding: "20px" }, children: _jsx(PieChart, { ...args, variant: "pie", appearance: "semiCircular" }) })] }), _jsxs("div", { children: [_jsx("h4", { style: { textAlign: "center", marginBottom: "16px" }, children: "Donut - Semicircle" }), _jsx(Card, { style: { padding: "20px" }, children: _jsx(PieChart, { ...args, variant: "donut", appearance: "semiCircular" }) })] })] })),
};
/**
 * ## Custom Palette
 *
...
export const CustomPalette = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "650px", height: "auto", padding: "24px" }, children: [_jsx("h3", { style: { marginBottom: "20px", fontSize: "18px", fontWeight: 600 }, children: "Chart with Custom Palette" }), _jsx(PieChart, { ...args })] })),
};
/**
 ...
 */
export const LargeDatasetWithCarousel = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px", padding: "24px" }, children: _jsx(PieChart, { ...args }) })),
};
export const ResponsiveDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the edges or corners of the container below to see how the chart adapts" }), _jsxs("div", { style: {
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(PieChart, { ...args }), _jsx("div", { style: { ...handleStyle, top: -2, left: 0, right: 0, height: 12, cursor: "ns-resize" }, onMouseDown: (e) => handleMouseDown(e, "n") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                left: 0,
                                right: 0,
