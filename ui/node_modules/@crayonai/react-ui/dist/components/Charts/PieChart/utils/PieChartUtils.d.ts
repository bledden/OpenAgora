 ...
 */
declare const createSectorStyle: (cornerRadius?: number, paddingAngle?: number) => {
    cornerRadius: number;
    paddingAngle: number;
};
export { calculateChartDimensions, calculatePercentage, calculateTwoLevelChartDimensions, createAnimationConfig, createEventHandlers, createSectorStyle, getHoverStyles, transformDataWithPercentages, useChartHover, };
