...
exports.useThreadManager = void 0;
    ...
    const store = (0, react_1.useMemo)(() => {
        return (0, zustand_1.createStore)((set) => {
            return {
                ...
                updateMessage: (message, shouldTriggerCallback) => {
                ...
                responseTemplates: propsRef.current.responseTemplates.reduce((acc, template) => {
...
//# sourceMappingURL=useThreadManager.js.map